      ...
      <Slider {...settings}>
        <div className="w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative">
          ...
          <div className="lg:absolute lg:top-1/2 lg:left-2/3 transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5">
            ...
            <button className="text-base font-medium text-white   bg-[#fcb900] rounded-md px-4 py-2">
              Select a Product
            </button>
          </div>
        </div>
        <div className="w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative">
          <div className="w-full lg:w-1/3 hidden lg:inline-block h-full bg-gray-200 z-0 relative">
            <Image
              src={sliderTwo}
              alt="sliderTwo"
          ...
          <div className="lg:absolute lg:top-1/2 lg:left-2/3 transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5">
            ...
            <button className="text-base font-medium text-white bg-gray-800 rounded-md px-4 py-2">
              Select a Product
            </button>
          </div>
        </div>
      ...
      <div className="h-20 bg-white absolute left-1/2 -bottom-10 transform -translate-x-1/2 hidden lg:inline-flex items-center gap-x-12 p-10">
        <div className="flex items-center gap-5 w-60">
          ...
          <div>
            ...
            <p className="font-semibold">7:00am - 8:00pm</p>
          </div>
        </div>
        <div className="flex items-center gap-5 w-60">
